...
public class IpDetails
{
    ...
    [JsonPropertyName("msa")] public string Msa { get; set; }

    [JsonPropertyName("dma")] public string Dma { get; set; }

    [JsonPropertyName("radius")] public object Radius { get; set; }

    [JsonPropertyName("ip_routing_type")] public object IpRoutingType { get; set; }

    [JsonPropertyName("connection_type")] public object ConnectionType { get; set; }

    [JsonPropertyName("location")] public Location Location { get; set; }

    [JsonPropertyName("time_zone")] public TimeZone TimeZone { get; set; }
...
public class Connection
{
    ...
    [JsonPropertyName("tld")] public string Tld { get; set; }
    ...
    [JsonPropertyName("isic_code")] public object IsicCode { get; set; }

    [JsonPropertyName("naics_code")] public object NaicsCode { get; set; }
}
...
public class Currency
{
    ...
    [JsonPropertyName("plural")] public string Plural { get; set; }

    [JsonPropertyName("symbol")] public string Symbol { get; set; }

    [JsonPropertyName("symbol_native")] public string SymbolNative { get; set; }
}
...
public class Location
{
    ...
    [JsonPropertyName("languages")] public List<Language> Languages { get; set; }
...
public class Security
{
    ...
    [JsonPropertyName("proxy_type")] public object ProxyType { get; set; }

    [JsonPropertyName("is_crawler")] public bool IsCrawler { get; set; }

    [JsonPropertyName("crawler_name")] public object CrawlerName { get; set; }

    [JsonPropertyName("crawler_type")] public object CrawlerType { get; set; }

    [JsonPropertyName("is_tor")] public bool IsTor { get; set; }

    [JsonPropertyName("threat_level")] public string ThreatLevel { get; set; }

    [JsonPropertyName("threat_types")] public object ThreatTypes { get; set; }

    [JsonPropertyName("proxy_last_detected")]
    public object ProxyLastDetected { get; set; }

    [JsonPropertyName("proxy_level")] public object ProxyLevel { get; set; }

    [JsonPropertyName("vpn_service")] public object VpnService { get; set; }

    [JsonPropertyName("anonymizer_status")]
    public object AnonymizerStatus { get; set; }

    [JsonPropertyName("hosting_facility")] public bool HostingFacility { get; set; }
}
...
public class TimeZone
{
    ...
    [JsonPropertyName("current_time")] public DateTime CurrentTime { get; set; }

    [JsonPropertyName("gmt_offset")] public int GmtOffset { get; set; }
